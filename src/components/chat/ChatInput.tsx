    ...
    <div className="px-6 pb-6">
      <div className="w-full max-w-4xl md:max-w-3xl min-w-[400px] mx-auto">
        <form onSubmit={handleSubmit}>
          <div className="relative flex items-end gap-3 rounded-2xl px-5 py-4 min-h-[60px]" style={{ backgroundColor: '#f3f4f6' }}>
            {/* DeepThink Button */}
            <button
              type="button"
              onClick={handleDeepThink}
              className="
                flex-shrink-0 bg-blue-100 hover:bg-blue-200 text-blue-700 
            ...
            <div className="flex-1 flex items-center">
              <textarea
                ...
                className="
                  ...
                  text-base leading-5 min-h-[20px] max-h-[140px]
                  disabled:opacity-50
                "
